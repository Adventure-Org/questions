...
\COPY questions(id , product_id, body, date_written, asker_name, asker_email, reported, helpful) FROM '/home/unbuntu/data/questions.csv' CSV HEADER;

\COPY answers(id, question_id, body, date_written, answerer_name, answerer_email, reported, helpful) FROM '/home/ubuntu/data/answers.csv' CSV HEADER;

\COPY answer_photos(id, answer_id, url) FROM '/home/ubuntu/data/answers_photos.csv' CSV HEADER;
